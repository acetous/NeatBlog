...
<html lang="en">
  <head>
    ...
    <link href="<?php echo stylesheet_path('/styles/modern/modern.min.css'); ?>?v=3" rel="stylesheet">
    <script src="<?php echo javascript_path('/scripts/modern/modern.min.js'); ?>?v=3"></script>
